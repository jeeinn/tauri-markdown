  ...
  zh_CN: {
    ...
    notifications: {
      ...
      imageHost: {
        ...
        importHint: '从 PicGo 原生配置文件导入图床设置',
  ...
  en_US: {
    ...
    notifications: {
      ...
      imageHost: {
        ...
        importHint: 'Import image host settings from PicGo native config file',
  ...
  ja_JP: {
    ...
    notifications: {
      ...
      imageHost: {
        ...
        importHint: 'PicGo ネイティブ設定ファイルから画像ホスト設定をインポート',
  ...
  ko_KR: {
    ...
    notifications: {
      ...
      imageHost: {
        ...
        importHint: 'PicGo 네이티브 설정 파일에서 이미지 호스트 설정 가져오기',
        importSuccess: 'PicGo 설정 가져오기 성공',
        importFailed: 'PicGo 설정 가져오기 실패, 설정 파일이 존재하는지 확인하세요',
      },
    },
  },
};

...
<script setup>
  ...
  onMounted(() => {
    instanceEditor.value = new Vditor("vditorEle", {
      // mode: 'sv', 默认为即时渲染模式
      // cdn: '..',
      lang: data.lang,
      cache: {
